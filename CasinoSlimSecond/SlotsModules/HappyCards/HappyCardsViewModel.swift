...
class HappyCardsViewModel: ObservableObject {
    let contact = HappyCardsModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 5
    let allFruits = ["happy1", "happy2", "happy3","happy4", "happy5", "happy6"]
    ...
    let symbolArray = [
        Symbol(image: "happy1", value: "100"),
        Symbol(image: "happy2", value: "50"),
        Symbol(image: "happy3", value: "20"),
        Symbol(image: "happy4", value: "15"),
        Symbol(image: "happy5", value: "5"),
        Symbol(image: "happy6", value: "3")
    ]
